...
FileWrite fw=new FileWriter(fname);
...
Process error=r.exec(""+fname);



BufferedReader err=new BufferedReader(new InputStream(error.getErrorStream()));
...
class MyFocusListener extends FocusAdaptor
{
MyEditor e;
